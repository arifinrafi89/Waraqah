...
mixin _$P2pListing {
 ...
 String get id; String get title; String get sellerName; String get sellerBatch; int get priceBdt; BookCondition get condition; bool get isAvailable; int get coverSeed;
...
int get hashCode {
  final _this = this as P2pListing;
  return Object.hash(runtimeType,_this.id,_this.title,_this.sellerName,_this.sellerBatch,_this.priceBdt,_this.condition,_this.isAvailable,_this.coverSeed);
}

@override
String toString() {
  final _this = this as P2pListing;
  return 'P2pListing(id: ${_this.id}, title: ${_this.title}, sellerName: ${_this.sellerName}, sellerBatch: ${_this.sellerBatch}, priceBdt: ${_this.priceBdt}, condition: ${_this.condition}, isAvailable: ${_this.isAvailable}, coverSeed: ${_this.coverSeed})';
}
...
@useResult
$Res call({
 String id, String title, String sellerName, String sellerBatch, int priceBdt, BookCondition condition, bool isAvailable, int coverSeed
});
...
/// Create a copy of P2pListing
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? sellerName = null,Object? sellerBatch = null,Object? priceBdt = null,Object? condition = null,Object? isAvailable = null,Object? coverSeed = null,}) {
...
as BookCondition,isAvailable: null == isAvailable ? _self.isAvailable : isAvailable // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String sellerName,  String sellerBatch,  int priceBdt,  BookCondition condition,  bool isAvailable,  int coverSeed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _P2pListing() when $default != null:
return $default(_that.id,_that.title,_that.sellerName,_that.sellerBatch,_that.priceBdt,_that.condition,_that.isAvailable,_that.coverSeed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String sellerName,  String sellerBatch,  int priceBdt,  BookCondition condition,  bool isAvailable,  int coverSeed)  $default,) {final _that = this;
switch (_that) {
case _P2pListing():
return $default(_that.id,_that.title,_that.sellerName,_that.sellerBatch,_that.priceBdt,_that.condition,_that.isAvailable,_that.coverSeed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String sellerName,  String sellerBatch,  int priceBdt,  BookCondition condition,  bool isAvailable,  int coverSeed)?  $default,) {final _that = this;
switch (_that) {
case _P2pListing() when $default != null:
return $default(_that.id,_that.title,_that.sellerName,_that.sellerBatch,_that.priceBdt,_that.condition,_that.isAvailable,_that.coverSeed);case _:
  return null;
...
class _P2pListing implements P2pListing {
  const _P2pListing({required this.id, required this.title, required this.sellerName, required this.sellerBatch, required this.priceBdt, this.condition = BookCondition.good, this.isAvailable = true, this.coverSeed = 0});
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,title,sellerName,sellerBatch,priceBdt,condition,isAvailable,coverSeed);
}

@override
String toString() {
    return 'P2pListing(id: $id, title: $title, sellerName: $sellerName, sellerBatch: $sellerBatch, priceBdt: $priceBdt, condition: $condition, isAvailable: $isAvailable, coverSeed: $coverSeed)';
}
...
/// Create a copy of P2pListing
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? sellerName = null,Object? sellerBatch = null,Object? priceBdt = null,Object? condition = null,Object? isAvailable = null,Object? coverSeed = null,}) {
